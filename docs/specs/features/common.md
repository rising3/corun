...
Usage: <コマンド名> <subcommand> [flags]

Run '<コマンド名> <subcommand> --help' for more information.
```
...
USAGE:
  <コマンド名> <subcommand> [flags] [arguments]
...
LEARN MORE:
  Use `<コマンド名> <subcommand> --help` for more information about a command.
```
